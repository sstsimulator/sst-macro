...
Numbers are ignored at the end of a keyword in determining whether it is valid, e.g. \inlinecode{link3 = X} will be valid if the keyword \inlinecode{"link"} is registered.
