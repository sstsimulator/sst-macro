...
\section{Applications and User-space Threads}\label{sec:appThreads}
...
\subsection{Thread-specific storage}\label{subsec:threadStorage}
...
The operating system provides an abstract interface (independent of the exact implementation of threading library)
through \inlinecode{key} objects.
Each blocking call:
