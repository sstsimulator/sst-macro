...
![<a name="fig:workflow"></a>](figures/workflow.pdf) <a name="fig:workflow"></a>
...
![<a name="fig:amm1"></a>](figures/amm/AMM1.pdf) <a name="fig:amm1"></a>
...
![<a name="fig:amm2"></a>](figures/amm/amm2_membus.pdf) <a name="fig:amm2"></a>
...
![<a name="fig:amm3"></a>](figures/amm/amm3_switch.pdf) <a name="fig:amm3"></a>
...
![<a name="fig:hdtorus:basic"></a>](figures/tikz/torus/torus.pdf) <a name="fig:hdtorus:basic"></a>
...
![<a name="fig:hdtorus:withnodes"></a>](figures/tikz/torus/withnodes.pdf) <a name="fig:hdtorus:withnodes"></a>
...
![<a name="fig:torus:basicrouting"></a>](figures/tikz/torus/minroutetorus.pdf) <a name="fig:torus:basicrouting"></a>
...
![<a name="fig:torus:minadrouting"></a>](figures/tikz/torus/minadroutetorus.pdf) <a name="fig:torus:minadrouting"></a>
...
![<a name="fig:des"></a>](figures/tikz/des/events.pdf) <a name="fig:des"></a>
...
![<a name="fig:tutorial:congestion"></a>](figures/network/congestion.pdf) <a name="fig:tutorial:congestion"></a>
...
![<a name="fig:allocation:first_available"></a>](figures/tikz/allocation/firstavailable.pdf) <a name="fig:allocation:first_available"></a>
...
![<a name="fig:allocation:cartesian"></a>](figures/tikz/allocation/cartesian.pdf) <a name="fig:allocation:cartesian"></a>
...
![<a name="fig:allocation:random"></a>](figures/tikz/allocation/random.pdf) <a name="fig:allocation:random"></a>
...
![<a name="fig:indexing:block"></a>](figures/tikz/indexing/block.pdf) <a name="fig:indexing:block"></a>
...
![<a name="fig:indexing:round_robin"></a>](figures/tikz/indexing/roundrobin.pdf) <a name="fig:indexing:round_robin"></a>
...
![<a name="fig:qcgraphone"></a>](figures/graphviz/callgraph1.pdf) <a name="fig:qcgraphone"></a>

*Figure 17: QCachegrind Call Graph of MPI Functions*



![<a name="fig:qcgraphtwo"></a>](figures/graphviz/callgraph2.pdf) <a name="fig:qcgraphtwo"></a>
...
![<a name="fig:spyplot"></a>](figures/spyplot/mpi_spyplot.pdf) <a name="fig:spyplot"></a>
...
![<a name="fig:ftq"></a>](figures/gnuplot/ftq/ftq.pdf) <a name="fig:ftq"></a>
...
![<a name="fig:topologies:hypercubeConnected"></a>](figures/tikz/hypercube/hypercube_connected.pdf) <a name="fig:topologies:hypercubeConnected"></a>
...
![<a name="fig:topologies:hypercubeAllocation"></a>](figures/tikz/hypercube/hypercube_allocation.pdf) <a name="fig:topologies:hypercubeAllocation"></a>
...
![<a name="fig:topologies:hypercubePath"></a>](figures/tikz/hypercube/hypercube_path.pdf) <a name="fig:topologies:hypercubePath"></a>
...
![<a name="fig:topologies:hypercubeValiant"></a>](figures/tikz/hypercube/hypercube_valiant.pdf) <a name="fig:topologies:hypercubeValiant"></a>
...
![<a name="fig:topologies:abstractfattree"></a>](figures/tikz/fattree/abstract_fattree.pdf) <a name="fig:topologies:abstractfattree"></a>
...
![<a name="fig:topologies:fattreeids"></a>](figures/tikz/fattree/fattree_ids.pdf) <a name="fig:topologies:fattreeids"></a>
...
![<a name="fig:topologies:dragonfly"></a>](figures/tikz/dragonfly/dragonfly.pdf) <a name="fig:topologies:dragonfly"></a>
...
![<a name="fig:topologies:dflyminroute"></a>](figures/tikz/dragonfly/dflyminroute.pdf) <a name="fig:topologies:dflyminroute"></a>
...
![<a name="fig:topologies:dflyvaliantroute"></a>](figures/tikz/dragonfly/dflyvaliant.pdf) <a name="fig:topologies:dflyvaliantroute"></a>
