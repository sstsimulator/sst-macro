...
\boxGrid{8}{3}{1.15cm}{\boxsize}{\boxsize}{0cm,0cm}{}{main}
\boxGrid{4}{1}{0.95cm}{\boxsize}{\boxsize}{0cm,3cm}{}{top}
\boxGrid{16}{1}{0.57cm}{0.4cm}{0.25cm}{0cm,-1.7cm}{}{nodes}
...
\draw [thick] (mainmesh11TxC) -- (topmesh31BxC);
\draw [thick] (mainmesh21TxC) -- (topmesh11BxC);
\draw [thick] (mainmesh21TxC) -- (topmesh31BxC);

\draw [thick] (mainmesh31TxC) -- (topmesh21BxC);
\draw [thick] (mainmesh31TxC) -- (topmesh41BxC);
\draw [thick] (mainmesh41TxC) -- (topmesh21BxC);
\draw [thick] (mainmesh41TxC) -- (topmesh41BxC);

\draw [thick] (mainmesh51TxC) -- (topmesh11BxC);
\draw [thick] (mainmesh61TxC) -- (topmesh31BxC);
\draw [thick] (mainmesh51TxC) -- (topmesh11BxC);
\draw [thick] (mainmesh61TxC) -- (topmesh31BxC);

\draw [thick] (mainmesh71TxC) -- (topmesh21BxC);
\draw [thick] (mainmesh71TxC) -- (topmesh41BxC);
\draw [thick] (mainmesh81TxC) -- (topmesh21BxC);
