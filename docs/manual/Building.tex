...
The recommended mode for maximum flexibility is to run using the SST core downloadable from \url{}.  
Building and installing sets up the discrete event simulation core require for all SST elements.
