...
\hline
name \paramType{string} & No default & torus, cascade, dragonfly, fat\_tree, butterfly, crossbar, tapered\_fat\_tree & The name of the topology to build. For details, see Section \ref{chapter:topologies} \\
\hline 
