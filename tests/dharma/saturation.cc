...
typedef spkt_unordered_map<dharma::message*,double> time_map;
  ...
  while (1) {
    ...
    if (msg->payload_type() == message::rdma_put_ack) {
      ...
      spkt_throw_printf(sprockit::illformed_error,
                       ...
                       dharma::message::tostr(msg->payload_type()));
    }
  }
...
)
{
  ...
  int me = comm_rank();
  for (int i=0; i < num_partners; ++i) {
    dharma::message::ptr msg = new dharma::message(inject_length);
