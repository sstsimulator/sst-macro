...
#include <dharma-mpi/mpi_types/mpi_type_fwd.h>

#include <dharma-mpi/mpi_request.h>
#include <dharma-mpi/mpi_status.h>

#include <dharma-mpi/mpi_comm/mpi_comm_factory.h>
#include <dharma-mpi/mpi_debug.h>

#include <sstmac/software/process/software_id.h>
#include <sstmac/software/process/key.h>
#include <sstmac/software/process/pmi.h>

#include <dharma-mpi/mpi_queue/mpi_queue_fwd.h>
...
class mpi_api :
  public dharma::sumi_dharma_transport
{
 ...
 private:
  ...
  void collective_progress_loop(dharma::collective::type_t ty, int tag, bool tmp_domain = false);
