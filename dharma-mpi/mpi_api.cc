...
#include <dharma-mpi/mpi_queue/user_thread_mpi_queue.h>

#include <dharma-mpi/mpi_api.h>
#include <dharma-mpi/mpi_api_persistent.h>
...
{
  sumi_dharma_transport::init_factory_params(params);
...
{
  sumi_dharma_transport::init_param1(id);
