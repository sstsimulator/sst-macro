...
#ifndef SSTMAC_SOFTWARE_LIBRARIES_MPI_MPI_STRATEGIES_MPICOREGATHER_H_INCLUDED
#define SSTMAC_SOFTWARE_LIBRARIES_MPI_MPI_STRATEGIES_MPICOREGATHER_H_INCLUDED
...
//
// Default strategy for gather operations.
//
class mpi_core_gather : public mpi_gather_strategy
{

 public:
  /// Must be virtual.
  virtual ~mpi_core_gather() throw() {}
