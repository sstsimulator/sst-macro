...
#ifndef SSTMAC_SOFTWARE_LIBRARIES_MPI_MPI_STRATEGIES_MPICORESEND_H_INCLUDED
#define SSTMAC_SOFTWARE_LIBRARIES_MPI_MPI_STRATEGIES_MPICORESEND_H_INCLUDED
...
class mpi_core_send : public mpi_send_strategy
{

 public:
  /// Goodbye.
  virtual ~mpi_core_send() throw();
