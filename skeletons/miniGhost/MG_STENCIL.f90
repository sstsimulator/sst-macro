...
CONTAINS
   ...
   SUBROUTINE MG_STENCIL ( IVAR, IERR, mype )
      ...
      SELECT CASE ( STENCIL )  
         ...
         CASE ( STENCIL_3D7PT )
            ...
            SELECT CASE ( IVAR )
               ...
               CASE ( 1 )
                  CALL MG_STENCIL_3D7PT (  IERR, mype )
               CASE ( 2 )
                  CALL MG_STENCIL_3D7PT ( IERR, mype )
               CASE ( 3 )
                  CALL MG_STENCIL_3D7PT (  IERR, mype )
         ...
         CASE ( STENCIL_3D27PT )
            ...
            SELECT CASE ( IVAR )
               ...
               CASE ( 1 )
                  CALL MG_STENCIL_3D27PT (  IERR, mype )
               CASE ( 2 )
                  CALL MG_STENCIL_3D27PT (  IERR, mype )
               CASE ( 3 )
                  CALL MG_STENCIL_3D27PT (  IERR, mype )
         ...
         CASE ( STENCIL_2D5PT )
            ...
            SELECT CASE ( IVAR )
               ...
               CASE ( 1 )
                  CALL MG_STENCIL_2D5PT (  IERR, mype )
               CASE ( 2 )
                  CALL MG_STENCIL_2D5PT (  IERR, mype )
               CASE ( 3 )
                  CALL MG_STENCIL_2D5PT (  IERR, mype )
         ...
         CASE ( STENCIL_2D9PT )
            ...
            SELECT CASE ( IVAR )
               ...
               CASE ( 1 )
                  CALL MG_STENCIL_2D9PT (  IERR, mype )
               CASE ( 2 )
                  CALL MG_STENCIL_2D9PT (  IERR, mype )
               CASE ( 3 )
                  CALL MG_STENCIL_2D9PT (  IERR, mype )
