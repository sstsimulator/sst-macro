...
//#endif
  ...
  int elemsize = (int) elemIDs.size();
  int num_elems_i = (int) num_elems;
#if defined(_USE_EIGER_MODEL) || defined(_USE_EIGER) || \
    defined(_USE_CSV) || defined(_USE_FAKEEIGER)
  PERFLOG(perform_element_loop, ID(global_elems_x), ID(global_elems_y), ID(global_elems_z), IN(elemsize), IN(num_elems_i));
#endif
...
#if defined(_USE_EIGER_MODEL) || defined(_USE_EIGER) || \
    defined(_USE_CSV) || defined(_USE_FAKEEIGER)
  PERFSTOP(perform_element_loop, ID(global_elems_x), ID(global_elems_y), ID(global_elems_z), IN(elemsize), IN(num_elems_i));
#endif
}
