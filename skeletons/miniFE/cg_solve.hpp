         ...
         timer_type* my_cg_times)
{
  ...
  int nrows_i = (int) nrows, ncols_i = (int) ncols, max_iter_i = (int) max_iter;
#if defined(_USE_EIGER_MODEL) || defined(_USE_EIGER) || \
    defined(_USE_CSV) || defined(_USE_FAKEEIGER)
  PERFLOG(cgsolve,IN(nrows_i),IN(ncols_i),ID(max_iter_i));
#endif
...
#if defined(_USE_EIGER_MODEL) || defined(_USE_EIGER) || \
    defined(_USE_CSV) || defined(_USE_FAKEEIGER)
  PERFSTOP(cgsolve,IN(nrows_i),IN(ncols_i),ID(max_iter_i));
#endif
}
